# DMVPN Phase2 + eigrp for routing between hub and spoke + ipsec + Route filtering


route filtering: 
		1- distribute-list + standard ACL
		2- distribute-list + extended ACL
		3- distribute-list + prefix list
		4- distribute-list + rotue-map
...
access-list 10 deny 10.10.8.0 0.0.0.255
access-list 10 permit any


router eigrp eig-dmvnp
address-family ipv4 unicast autonomous-system 2
topology base
distribute-list 10 in tunnel 1



! in the classic(numberd) eigrp 
! router eigrp 2
! distribute-list 10 in tunnel 1

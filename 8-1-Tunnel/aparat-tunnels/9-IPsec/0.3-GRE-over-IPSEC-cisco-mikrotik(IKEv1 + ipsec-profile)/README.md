# GRE over IPsec  Mikrotik + cisco ( IKE version-1 & IPsec Profile)
### 
...
router ospf 1
 network 172.16.1.11 0.0.0.0 area 0
 network 172.17.1.11 0.0.0.0 area 0
...
router ospf 1
 ...
 network 10.10.50.1 0.0.0.0 area 0
